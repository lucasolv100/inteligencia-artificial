    ...
    public class GeneticAlgorithm
    {
        ...
        public Population Execute(Population population)
        {
            ...
            for (int i = 0; i < Constants.sizePopulation / 2; i++)
            {
                ...
                indBuffer.Add(children[0]);
                indBuffer.Add(children[1]);
            }
        ...
        public Individual[] CrossOverIndividual(Individual father, Individual mother)
        {
            ...
            int cutPoint = Constants.random.Next(0, Constants.sizeChromosome);
        ...
        //{
        //    var random = Constants.random.NextDouble();
        //    if (random <= this.MutationTax)
        //    {
